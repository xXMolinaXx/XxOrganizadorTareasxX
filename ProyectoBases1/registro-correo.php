                ...
                <div id="div1-1-1-1">
                    ...
                    <div>
                        ...
                        <center>
                            ...
                            <input id="correo-electronico" class="diseno" type="text" placeholder="Correo electronico">
                            ...
                            <input id="fechaNacimiento" class="diseno" type="text" placeholder="fecha nacimiento anio-mes-dia">
                        </center>
